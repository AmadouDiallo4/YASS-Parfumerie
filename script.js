...
const products = [
  ...
  // Cosmétiques
  { id: 6,  name: "Savon Lavande",            category: "cosmetique",      gender: "mixte", icon: "💜", price: 6.90,  desc: "Savon artisanal à la lavande et huile d'argan. 100 g.",      image: "" },
  { id: 7,  name: "Savon Karité",             category: "cosmetique",      gender: "mixte", icon: "🧼", price: 7.50,  desc: "Beurre de karité pur, hydratation intense. 100 g.",          image: "" },
  { id: 8,  name: "Savon Charbon Actif",      category: "cosmetique",      gender: "mixte", icon: "⚫", price: 8.20,  desc: "Purifiant et détoxifiant, peau nette. 100 g.",               image: "" },
  { id: 9,  name: "Savon Rose & Miel",        category: "cosmetique",      gender: "mixte", icon: "🌸", price: 7.90,  desc: "Douceur et éclat, formule nourrissante. 100 g.",             image: "" },
  { id: 10, name: "Dentifrice Charbon",       category: "cosmetique",      gender: "mixte", icon: "🦷", price: 8.90,  desc: "Blanchiment naturel au charbon actif. 75 ml.",                image: "" },
  { id: 11, name: "Dentifrice Menthe Forte",  category: "cosmetique",      gender: "mixte", icon: "🌿", price: 5.90,  desc: "Fraîcheur longue durée, formule fluorée. 75 ml.",             image: "" },
  { id: 12, name: "Dentifrice Argile Blanche",category: "cosmetique",      gender: "mixte", icon: "🏔️", price: 9.50,  desc: "Soin des gencives à l'argile pure. 60 ml.",                  image: "" },
  { id: 13, name: "Déo Fleur de Coton",       category: "cosmetique",      gender: "mixte", icon: "🌼", price: 9.90,  desc: "Fraîcheur 48 h, sans sels d'aluminium. 150 ml.",              image: "" },
  { id: 14, name: "Déo Bois & Musc",          category: "cosmetique",      gender: "mixte", icon: "🌳", price: 10.50, desc: "Boisé et subtil, confort toute la journée. 150 ml.",           image: "" },
  { id: 15, name: "Déo Aloe Vera",            category: "cosmetique",      gender: "mixte", icon: "🌱", price: 9.00,  desc: "Douceur de l'aloe vera, peau sensible. 150 ml.",               image: "" },
